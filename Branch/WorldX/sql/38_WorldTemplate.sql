...
CREATE TABLE `creature_proto` (
  ...
  `power` int(30) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `quests` (
  ...
  `ReqItemId5` int(11) unsigned NOT NULL DEFAULT '0',
  `ReqItemId6` int(11) unsigned NOT NULL DEFAULT '0',
  ...
  `ReqItemCount5` int(11) unsigned NOT NULL DEFAULT '0',
  `ReqItemCount6` int(11) unsigned NOT NULL DEFAULT '0',
...
-- ----------------------------
-- Table structure for spell_proc_override
-- ----------------------------
