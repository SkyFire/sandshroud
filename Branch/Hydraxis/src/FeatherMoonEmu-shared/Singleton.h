...
#else
	FEATHERMOONEMU_INLINE static type & getSingleton( ) { WPAssert( mSingleton ); return *mSingleton; }
	FEATHERMOONEMU_INLINE static type * getSingletonPtr( ) { return mSingleton; }
#endif
