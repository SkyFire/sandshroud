...
public:
	...
	bool IsOutDebug() const { return m_screenLogLevel >= 3 || (m_fileLogLevel >= 3 && m_file); }
	bool IsOutProcess() const { return m_screenLogLevel >= 4 || (m_fileLogLevel >= 4 && m_file); }
...
public:
	...
	FEATHERMOONEMU_INLINE bool IsOpen() { return (m_file != NULL); }
	void Open();
	void Close();
};
