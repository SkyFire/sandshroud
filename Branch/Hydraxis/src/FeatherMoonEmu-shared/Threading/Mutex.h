...
public:
	 ...
	 */
	FEATHERMOONEMU_INLINE void Acquire()
	{
#ifndef WIN32
	 ...
	 */
	FEATHERMOONEMU_INLINE void Release()
	{
#ifndef WIN32
	 ...
	 */
	FEATHERMOONEMU_INLINE bool AttemptAcquire()
	{
#ifndef WIN32
...
public:
	FEATHERMOONEMU_INLINE FastMutex() : m_lock(0),m_recursiveCount(0) {}
	FEATHERMOONEMU_INLINE ~FastMutex() {}
