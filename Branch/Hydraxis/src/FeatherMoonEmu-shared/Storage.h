...
public:
	 ...
	 */
	FEATHERMOONEMU_INLINE T * Get() { return Pointer; }

	/** Sets the current object to P
	 */
	FEATHERMOONEMU_INLINE void Set(T * P) { Pointer = P; }

	/** Are we at the end of the storage container?
	 */
	FEATHERMOONEMU_INLINE bool AtEnd() { return (Pointer == 0); }
...
public:
	...
	FEATHERMOONEMU_INLINE char * GetIndexName() { return _indexName; }
	FEATHERMOONEMU_INLINE char * GetFormatString() { return _formatString; }
...
public:
	 ...
	 */
	FEATHERMOONEMU_INLINE void LoadBlock(Field * fields, T * Allocated)
	{
