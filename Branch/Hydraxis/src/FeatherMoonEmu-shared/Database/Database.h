...
public:
	...
	void Perform();
	FEATHERMOONEMU_INLINE void SetDB(Database * dbb) { db = dbb; }
};
...
public:
	...
	FEATHERMOONEMU_INLINE const string& GetHostName() { return mHostname; }
	FEATHERMOONEMU_INLINE const string& GetDatabaseName() { return mDatabaseName; }
	FEATHERMOONEMU_INLINE const uint32 GetQueueSize() { return queries_queue.get_size(); }
...
public:
	...
	FEATHERMOONEMU_INLINE Field* Fetch() { return mCurrentRow; }
	FEATHERMOONEMU_INLINE uint32 GetFieldCount() const { return mFieldCount; }
	FEATHERMOONEMU_INLINE uint32 GetRowCount() const { return mRowCount; }
