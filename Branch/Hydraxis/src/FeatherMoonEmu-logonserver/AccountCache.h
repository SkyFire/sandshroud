...
public:
	...
	FEATHERMOONEMU_INLINE size_t GetCount() { return AccountDatabase.size(); }
...
public:
	FEATHERMOONEMU_INLINE Mutex & getServerSocketLock() { return serverSocketLock; }
	FEATHERMOONEMU_INLINE Mutex & getRealmLock() { return realmLock; }
	...
	FEATHERMOONEMU_INLINE void   AddServerSocket(LogonCommServerSocket * sock) { serverSocketLock.Acquire(); m_serverSockets.insert( sock ); serverSocketLock.Release(); }
	FEATHERMOONEMU_INLINE void   RemoveServerSocket(LogonCommServerSocket * sock) { serverSocketLock.Acquire(); m_serverSockets.erase( sock ); serverSocketLock.Release(); }
