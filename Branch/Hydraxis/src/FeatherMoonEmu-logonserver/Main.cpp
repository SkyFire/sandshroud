...
#define BANNER "FeatherMoonEmu r%u/%s-%s (%s) :: Logon Server\n"
...
{
#ifdef WIN32
	char * config_file = "FeatherMoonEmu-logonserver.conf";
#else
	char * config_file = (char*)CONFDIR "/FeatherMoonEmu-logonserver.conf";
#endif
...
void LogonServer::Run(int argc, char ** argv)
{
	...
	min_build = Config.MainConfig.GetIntDefault("Client", "MinBuild", 10958);
	max_build = Config.MainConfig.GetIntDefault("Client", "MaxBuild", 10958);
