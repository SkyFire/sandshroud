...
public:
	...
	FEATHERMOONEMU_INLINE bool IsArena() { return (m_type >= BATTLEGROUND_ARENA_2V2 && m_type <= BATTLEGROUND_ARENA_5V5); }
...
public:
	...
	FEATHERMOONEMU_INLINE uint32 GetLevelGroup() { return m_levelGroup; }
	FEATHERMOONEMU_INLINE MapMgr* GetMapMgr() { return m_mapMgr; }
	...
	/* Has it ended? */
	FEATHERMOONEMU_INLINE bool HasEnded() { return m_ended; }
	FEATHERMOONEMU_INLINE bool HasStarted() { return m_started; }
	...
	/* Full? */
	FEATHERMOONEMU_INLINE bool IsFull() { return !(HasFreeSlots(0) || HasFreeSlots(1)); }
	...
	FEATHERMOONEMU_INLINE uint32 GetStartTime() { return m_startTime; }
	FEATHERMOONEMU_INLINE uint32 GetType() { return m_type; }
	...
	FEATHERMOONEMU_INLINE uint32 GetLastResurrect() { return m_lastResurrect; }
