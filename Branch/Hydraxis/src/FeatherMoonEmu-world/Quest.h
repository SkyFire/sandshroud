...
public:
	...
	FEATHERMOONEMU_INLINE Quest* GetQuest() { return m_quest; };
	...
	FEATHERMOONEMU_INLINE bool IsCastQuest() { return iscastquest;}
	...
	FEATHERMOONEMU_INLINE uint32 GetPlayerSlainCount() { return m_player_slain; }
	FEATHERMOONEMU_INLINE uint32 GetMobCount(uint32 i) { return m_mobcount[i]; }
	FEATHERMOONEMU_INLINE uint32 GetExploredAreas(uint32 i) { return m_explored_areas[i]; }
	FEATHERMOONEMU_INLINE uint32 GetTimeLeft() { return m_time_left; }

	FEATHERMOONEMU_INLINE uint32 GetBaseField(uint32 slot)
	{
