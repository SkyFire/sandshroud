...
FEATHERMOONEMU_INLINE void* allocate_and_copy(uint32 len, void * pointer)
{
...
void CommandTableStorage::Init()
{
	static ChatCommand modifyCommandTable[] =
	{
		...
		{ "strength",	 'm', NULL,	"Strength",			  NULL, UNIT_FIELD_STAT0,		   0,			  1 },
		{ "strength1",	 'm', NULL,	"Strength1",			  NULL, UNIT_FIELD_STAT1,		   0,			  1 },
		{ "strength2",	 'm', NULL,	"Strength2",			  NULL, UNIT_FIELD_STAT2,		   0,			  1 },
		{ "strength3",	 'm', NULL,	"Strength3",			  NULL, UNIT_FIELD_STAT3,		   0,			  1 },
		{ "strength4",	 'm', NULL,	"Strength4",			  NULL, UNIT_FIELD_STAT4,		   0,			  1 },
	...
	{
		{ "delete",	'c', &ChatHandler::HandleVehicleDeleteCommand, "Deletes Vehicle", NULL, 0, 0, 0 },
		{ NULL, 0, NULL, "", NULL, 0, 0 }
	};
	...
	{
		{ "vendoraddset",   'z', &ChatHandler::HandleItemSetCommand,     "Adds item set to vendor",             NULL, 0, 0, 0},
	...
	static ChatCommand commandTable[] = {
		...
		{ "lookupcreature", 'l', &ChatHandler::HandleLookupCreatureCommand, "Looks up item string x.", NULL, 0, 0, 0 },
 		{ "lookupcreature", 'l', &ChatHandler::HandleLookupCreatureCommand, "Looks up item string x.", NULL, 0, 0, 0 },
		{ "lookupspell", 'l', &ChatHandler::HandleLookupSpellCommand, "Looks up spell string x.", NULL, 0, 0, 0 },
		{ "lookupobject", 'l', &ChatHandler::HandleLookupObjectCommand, "Looks up object string x.", NULL, 0, 0, 0 },
		...
		{ "who", 'w', &ChatHandler::HandleWhoCommand, "Queries server for ", NULL, 0, 0, 0 },
