...
void AchievementInterface::GiveRewardsForAchievement(AchievementEntry * ae)
{
	...
	if( ar->ItemID )
	{
		...
		if( !m_player->GetItemInterface()->AddItemToFreeSlot(pItem) )
		{
			...
			sMailSystem.DeliverMessage(NORMAL, m_player->GetGUID(), m_player->GetGUID(), "Achievement Reward", "Here is your reward.", 0, 0, ar->ItemID, 1, true);
			pItem->Destructor();
		}
	}
	...
	if(m_player->GetTeam() == ALLIANCE)
	{
		if( ar->AllianceTitle )
		{
			...
			m_player->SetUInt32Value( PLAYER_CHOSEN_TITLE, 0 );
		}
	}
...
void AchievementInterface::HandleAchievementsFromAchievements(AchievementData * pData, uint32 ID)
{
	AchievementEntry * pAchievementEntry = dbcAchievement.LookupEntryForced(ID);
	{
		...
		case 4079: // A Tribute to Immortality
			{
				if(&AchievementInterface::EventAchievementEarned)
				m_player->addSpell(68188);
			}
		case 4156: // A Tribute to Immortality
			{
				if(&AchievementInterface::EventAchievementEarned)
				m_player->addSpell(68187);
			}
		}
	}
}

bool EarnOnlyOncePerRealm (uint32 achievementID, const Player* plr)
{
	switch(achievementID)
	{
		case 416: //Scarab Lord Achievement(Should be once per realm since you only get the title once :P if someone can confirm turn it on).
		case 456: //First Sartharion Slaying(Gives Title Reward: Obsidian Slayer).
		case 457: //First level 80 ftw :P.
		case 458: //First level 80 Rogue.
		case 459: //First level 80 Warrior.
		case 460: //First level 80 Mage.
		case 461: //First level 80 Deathknight.
		case 462: //First level 80 Hunter.
		case 463: //First level 80 Warlock.
		case 464: //First level 80 Priest.
		case 465: //First level 80 Paladin.
		case 466: //First level 80 Druid.
		case 467: //First level 80 Shaman.
		case 1400: //First Malygos Slaying(Gives Title Reward: The Magic Seeker)
		case 1402: //First Kel'Thuzad Slaying(Gives Title Reward: Conqueror of Naxxramas)
		case 1404: //First Level 80 Gnome(Racial)
		case 1405: //First Level 80 Blood Elf(Racial)
		case 1406: //First Level 80 Dreani(Racial)
		case 1407: //First Level 80 Gnome(Racial)
		case 1408: //First Level 80 Human(Racial)
		case 1409: //First Level 80 Night Elf(Racial)
		case 1410: //First Level 80 Orc(Racial)
		case 1411: //First Level 80 Moo Cow(Racialism)
		case 1412: //First Level 80 Troll(Racial)
		case 1413: //First Level 80 Forsaken(Racial)
		case 1414: //First Grandmaster Blacksmith(Professions)
		case 1415: //First Grandmaster Alchemist(Professions)
		case 1416: //First Grandmaster Cooking(Professions)
		case 1417: //First Grandmaster Enchanting(Professions)
		case 1418: //First Grandmaster Engineering(Professions)
		case 1419: //First Grandmaster First Aid(Professions)
		case 1420: //First Grandmaster Fishing(Professions)
		case 1421: //First Grandmaster Herbalism(Professions)
		case 1422: //First Grandmaster Inscription(Professions)
		case 1423: //First Grandmaster Jewelcrafting(Professions)
		case 1424: //First Grandmaster Leatherworking(Professions)
		case 1425: //First Grandmaster Mining(Professions)
		case 1426: //First Grandmaster Skinning(Professions)
		case 1427: //First Grandmaster Tailoring(Professions)
		case 1463: //First Person To Get Exalted With Argent Crusade, Wyrmrest Accord, Kirin Tor, And Knights of the Ebon Blade.
		case 3117: //First Yarg Sarron Slaying(Gives Title Reward: Death's Demise)
		case 3259: //First Algalon Slaying(Gives Title Reward: The Celestial Defender)
			{
				QueryResult* achievementResult = CharacterDatabase.Query("SELECT guid FROM achievements WHERE achievement=%u ORDER BY date LIMIT 1", achievementID);
