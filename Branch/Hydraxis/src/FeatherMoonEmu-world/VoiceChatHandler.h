...
#include "../FeathermoonEmu-voicechat/FeathermoonEmu_opcodes.h"
...
public:
	...
	FEATHERMOONEMU_INLINE uint32 GetVoiceServerIP() { return ip; }
	FEATHERMOONEMU_INLINE uint16 GetVoiceServerPort() { return port; }
