...
const char * gAreaTriggerFormat							= "ucuusffffuuu";
...
const char * gGameObjectNameFormat						= "uuusuuuuuuuuuuuuuuuuuuuuuuuuuuu";
const char * gGraveyardFormat							= "uffffuuuux";
const char * gItemPageFormat							= "usu";
const char * gItemPrototypeFormat						= "uuuussssuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuffuffuuuuuuuuuufuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuusuuuuuuuuuuuuuuuuuuuuuuuuuuu";
...
const char * gWorldMapInfoFormat						= "uuuuufffusuuuuuufub";
...
void ObjectMgr::LoadExtraItemStuff()
{
	...
	while(!itr->AtEnd())
	{
		...
		pItemPrototype->lowercase_name = itr->Get()->Name;
...
{
	{
		...
		while(!itr->AtEnd())
		{
			...
			for(list<AI_Spell*>::iterator it = p->AIspells.begin(); it != p->AIspells.end(); ++it)
				delete (*it);
			p->AIspells.clear();
			p->start_auras.clear();
			if(!itr->Inc())
