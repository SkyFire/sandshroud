...
enum MailError
{
	...
	MAIL_ERR_CANNOT_MAIL_SOULBOUND_ITEMS = 7
};
...
public:
	...
	FEATHERMOONEMU_INLINE size_t MessageCount() { return Messages.size(); }
	FEATHERMOONEMU_INLINE uint64 GetOwner() { return owner; }
...
public:
	...
	FEATHERMOONEMU_INLINE bool MailOption(uint32 flag)
	{
