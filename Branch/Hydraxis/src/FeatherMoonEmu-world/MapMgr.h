...
/////////////////////////////////////////////
	...
	FEATHERMOONEMU_INLINE const uint32 GenerateGameobjectGuid()
	{
		m_GOHighGuid &= 0x00FFFFFF;
		return ++m_GOHighGuid;
	}

	FEATHERMOONEMU_INLINE GameObject* GetGameObject(const uint32 guid)
	{
...
////////////////////////////////////////////
	...
	FEATHERMOONEMU_INLINE DynamicObject* GetDynamicObject(const uint32 guid)
	{
...
////////////////////////////////
	...
	FEATHERMOONEMU_INLINE bool IsCombatInProgress()
	{ 
...
///////////////////////////////////
	...
	// Terrain Functions
	FEATHERMOONEMU_INLINE float  GetLandHeight(float x, float y) { return GetBaseMap()->GetLandHeight(x, y); }
	FEATHERMOONEMU_INLINE float  GetWaterHeight(float x, float y) { return GetBaseMap()->GetWaterHeight(x, y); }
	FEATHERMOONEMU_INLINE uint8  GetWaterType(float x, float y) { return GetBaseMap()->GetWaterType(x, y); }
	FEATHERMOONEMU_INLINE uint8  GetWalkableState(float x, float y) { return GetBaseMap()->GetWalkableState(x, y); }
	FEATHERMOONEMU_INLINE uint16 GetAreaID(float x, float y, float z =0)
	{
	...
	FEATHERMOONEMU_INLINE uint32 GetMapId() { return _mapId; }
	...
	FEATHERMOONEMU_INLINE bool HasPlayers() { return (m_PlayerStorage.size() > 0); }
	void TeleportPlayers();

	FEATHERMOONEMU_INLINE uint32 GetInstanceID() { return m_instanceID; }
	FEATHERMOONEMU_INLINE MapInfo *GetMapInfo() { return pMapInfo; }

	FEATHERMOONEMU_INLINE void SetCollision(bool enable) { collision = enable; }
	FEATHERMOONEMU_INLINE bool IsCollisionEnabled() { return collision; }

	FEATHERMOONEMU_INLINE MapScriptInterface * GetInterface() { return ScriptInterface; }
	virtual int32 event_GetInstanceID() { return m_instanceID; }

	void LoadAllCells();
	FEATHERMOONEMU_INLINE size_t GetPlayerCount() { return m_PlayerStorage.size(); }
...
public:
	...
	// get!
	FEATHERMOONEMU_INLINE WorldStateManager& GetStateManager() { return *m_stateManager; }
...
public:
	...
	void AreaIDScripts(Player* plr, uint16 GetAreaID, uint32 spellId, uint32);
