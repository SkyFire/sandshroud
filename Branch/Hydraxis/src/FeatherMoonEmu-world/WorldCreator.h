...
public:
	...
	FEATHERMOONEMU_INLINE Map* GetMap(uint32 mapid)
	{
		if(mapid>NUM_MAPS)
			return NULL;
		else
	...
	FEATHERMOONEMU_INLINE uint8 PlayerOwnsInstance(Instance * pInstance, Player* pPlayer)
	{
		// expired?
	...
	FEATHERMOONEMU_INLINE bool HasInstanceExpired(Instance * pInstance)
	{
