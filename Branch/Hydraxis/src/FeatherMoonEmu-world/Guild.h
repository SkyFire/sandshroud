...
public:
	...
	/** Gets MOTD
	 */
	FEATHERMOONEMU_INLINE const char * GetMOTD() const { return m_motd; }
	 ...
	 */
	FEATHERMOONEMU_INLINE const char * GetGuildInformation() const { return m_guildInfo; }
	...
	/** Getters :P
	 */
	FEATHERMOONEMU_INLINE const char * GetGuildName() const { return m_guildName; }
	FEATHERMOONEMU_INLINE const uint32 GetGuildLeader() const { return m_guildLeader; }
	FEATHERMOONEMU_INLINE const uint32 GetGuildId() const { return m_guildId; }
	FEATHERMOONEMU_INLINE const uint32 GetBankTabCount() const { return m_bankTabCount; }
	FEATHERMOONEMU_INLINE const uint32 GetBankBalance() const { return m_bankBalance; }
	FEATHERMOONEMU_INLINE const size_t GetNumMembers() const { return m_members.size(); }
	 ...
	 */
	FEATHERMOONEMU_INLINE GuildRank * GetGuildRank(uint32 Id)
	{ 
	...
	FEATHERMOONEMU_INLINE GuildBankTab * GetBankTab(uint32 Id)
	{
	 ...
	 */
	FEATHERMOONEMU_INLINE GuildMember * GetGuildMember(PlayerInfo * pInfo)
	{
