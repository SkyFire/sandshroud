...
/*	typedef struct { const char *name; int(*mfunc)(lua_State*,GameObject* ); } RegType;
	...
	FEATHERMOONEMU_INLINE GameObjectInfo* GetInfo() { return pInfo; }
	FEATHERMOONEMU_INLINE void SetInfo(GameObjectInfo * goi) { pInfo = goi; }
	...
	FEATHERMOONEMU_INLINE bool isQuestGiver()
	{
	...
	FEATHERMOONEMU_INLINE GameObjectAIScript* GetScript() { return myScript; }

	void TrapSearchTarget();	// Traps need to find targets faster :P

	FEATHERMOONEMU_INLINE bool HasAI() { return spell != 0; }
	GOSpawn * m_spawn;
	void OnPushToWorld();
	void OnRemoveInRangeObject(Object* pObj);
	void RemoveFromWorld(bool free_guid);

	FEATHERMOONEMU_INLINE bool CanMine(){return (mines_remaining > 0);}
	FEATHERMOONEMU_INLINE void UseMine(){ if(mines_remaining) mines_remaining--;}
	...
	FEATHERMOONEMU_INLINE void SetScript(GameObjectAIScript *pScript) { myScript = pScript; }
...
//	custom functions for scripting
	...
	uint8 GetState();
	uint64 GetRotation() { return m_rotation; }
