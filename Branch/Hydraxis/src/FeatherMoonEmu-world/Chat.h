...
public:
	...
	FEATHERMOONEMU_INLINE ChatCommand * Get() { return _commandTable; }
};
...
protected:
	...
	bool HandleVehicleDeleteCommand(const char* args, WorldSession *m_session);
	...
	bool HandleWhoCommand(const char*args, WorldSession *m_session);
