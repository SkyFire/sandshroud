...
FEATHERMOONEMU_INLINE bool isFriendly(Object* objA, Object* objB)// B is friendly to A if its not hostile
{
	return !isHostile(objA, objB);
}

FEATHERMOONEMU_INLINE bool isSameFaction(Object* objA, Object* objB)
{
...
FEATHERMOONEMU_INLINE  Player* GetPlayerFromObject(Object* obj); 
#endif
