...
protected:
	...
	FEATHERMOONEMU_INLINE int32 event_GetCurrentInstanceId() { return m_event_Instanceid; }
...
public:
	...
	FEATHERMOONEMU_INLINE bool event_HasEvents() { return m_events.size() > 0 ? true : false; }
...
public:
	...
	FEATHERMOONEMU_INLINE uint32 GetInstanceID() { return mInstanceId; }
