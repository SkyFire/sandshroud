...
FEATHERMOONEMU_INLINE void SetFlagAtWar(uint8 & flag)
{
...
FEATHERMOONEMU_INLINE void UnsetFlagAtWar(uint8 & flag)
{
	if(!(flag & FACTION_FLAG_AT_WAR))
		return;
...
FEATHERMOONEMU_INLINE void SetFlagVisible(uint8 & flag)
{
...
FEATHERMOONEMU_INLINE void SetFlagPeaceForced(uint8 & flag)
{
...
FEATHERMOONEMU_INLINE void SetForcedInvisible(uint8 & flag)
{
...
FEATHERMOONEMU_INLINE void UnsetFlagVisible(uint8 & flag)
{
	if(!(flag & FACTION_FLAG_VISIBLE))
		return;
...
FEATHERMOONEMU_INLINE bool AtWar(uint8 flag) { return (flag & FACTION_FLAG_AT_WAR) ? true : false; }
FEATHERMOONEMU_INLINE bool Visible(uint8 flag) { return (flag & FACTION_FLAG_VISIBLE) ? true : false; }

FEATHERMOONEMU_INLINE bool RankChanged(int32 Standing, int32 Change)
{
...
FEATHERMOONEMU_INLINE bool RankChangedFlat(int32 Standing, int32 NewStanding)
{
