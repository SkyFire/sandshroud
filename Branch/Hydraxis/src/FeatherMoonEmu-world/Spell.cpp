...
void Spell::HandleTeleport(uint32 id, Unit* Target)
{
	...
	if (m_spellInfo->Id == 8690 || m_spellInfo->Id == 556 || m_spellInfo->Id == 39937)// 8690 - FeathermoonEmu ; 556 - Astral Recall ; 39937 - Ruby Slippers
	{
...
void Spell::Heal(int32 amount)
{
	...
	if( m_spellInfo->Id != 53652 && unitTarget->BeaconCaster && unitTarget->BeaconTarget && u_caster && u_caster == unitTarget->BeaconCaster )
	{
		...
		Spell* sp = NULLSPELL;
		sp = (new Spell( unitTarget->BeaconCaster, spellInfo, true, NULLAURA ));
