...
public:
	...
	FEATHERMOONEMU_INLINE size_t GetObjectCount() { return _objects.size(); }
	void RemoveObjects();
	FEATHERMOONEMU_INLINE ObjectSet::iterator Begin() { return _objects.begin(); }
	FEATHERMOONEMU_INLINE ObjectSet::iterator End() { return _objects.end(); }

	//State Related
	void SetActivity(bool state);

	FEATHERMOONEMU_INLINE bool IsActive() { return _active; }
	FEATHERMOONEMU_INLINE bool IsLoaded() { return _loaded; }

	//Object Loading Managing
	void LoadObjects(CellSpawns * sp);
	FEATHERMOONEMU_INLINE uint32 GetPlayerCount() { return _playerCount; }
	...
	FEATHERMOONEMU_INLINE bool IsUnloadPending() { return _unloadpending; }
	FEATHERMOONEMU_INLINE void SetUnloadPending(bool up) { _unloadpending = up; }
