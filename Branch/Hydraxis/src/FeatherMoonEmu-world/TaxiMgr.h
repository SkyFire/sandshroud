...
public:
	...
	FEATHERMOONEMU_INLINE uint32 GetID() { return id; }
	...
	FEATHERMOONEMU_INLINE size_t GetNodeCount() { return m_pathNodes.size(); }
	TaxiPathNode* GetPathNode(uint32 i);
	FEATHERMOONEMU_INLINE uint32 GetPrice() { return price; }
	FEATHERMOONEMU_INLINE uint32 GetSourceNode() { return from; }
