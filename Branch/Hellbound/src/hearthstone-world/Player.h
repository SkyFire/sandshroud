...
enum RankTitles
{
	...
	TITLE_RECRUIT_OF				= 143,
	TITLE_GUARDIAN_OF				= 144,
	TITLE_VETERAN_OF				= 145,
	TITLE_EXALTED_OF				= 146,
	TITLE_END						= 147
};
...
const float baseDodge[12] = { 0.1f, 3.4636f, 3.2685f, -5.45f, -0.5900f, 3.1830f, 3.4636f, 1.6750f, 3.4575f, 2.0350f, 0.1f, 4.951f };
...
{ 0.1f, 0.0113f, 0.0135f, 0.0084f, 0.0084f, 0.0135f, 0.0113f, 0.0084f, 0.0137f, 0.0139f, 0.1f, 0.0084f },// Level 81
{ 0.1f, 0.0079f, 0.0095f, 0.0059f, 0.0059f, 0.0094f, 0.0079f, 0.0059f, 0.0097f, 0.0098f, 0.1f, 0.0059f },// Level 82
{ 0.1f, 0.0055f, 0.0067f, 0.0042f, 0.0042f, 0.0067f, 0.0055f, 0.0042f, 0.0068f, 0.0069f, 0.1f, 0.0042f },// Level 83
{ 0.1f, 0.0039f, 0.0047f, 0.0029f, 0.0029f, 0.0047f, 0.0039f, 0.0029f, 0.0048f, 0.0048f, 0.1f, 0.0029f },// Level 84
{ 0.1f, 0.0027f, 0.0033f, 0.0021f, 0.0021f, 0.0033f, 0.0027f, 0.0021f, 0.0033f, 0.0034f, 0.1f, 0.0021f }// Level 85
};
...
*/
	...
	int32 GetPhaseForLocation(uint32 Mapid, float x, float y, float z);
	...
	void EventTeleport(uint32 mapid, float x, float y, float z, float o = 0.0f, int32 phase = 0);
