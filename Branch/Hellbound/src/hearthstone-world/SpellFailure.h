...
enum SpellCastError
{
    ...
    SPELL_FAILED_FALLING = 33,
    SPELL_FAILED_FIZZLE = 34,
    SPELL_FAILED_FLEEING = 35,
    SPELL_FAILED_FOOD_LOWLEVEL = 36,
    SPELL_FAILED_HIGHLEVEL = 37,
    SPELL_FAILED_HUNGER_SATIATED = 38,
    SPELL_FAILED_IMMUNE = 39,
    SPELL_FAILED_INCORRECT_AREA = 40,
    SPELL_FAILED_INTERRUPTED = 41,
    SPELL_FAILED_INTERRUPTED_COMBAT = 42,
    SPELL_FAILED_ITEM_ALREADY_ENCHANTED = 43,
    SPELL_FAILED_ITEM_GONE = 44,
    SPELL_FAILED_ITEM_NOT_FOUND = 45,
    SPELL_FAILED_ITEM_NOT_READY = 46,
    SPELL_FAILED_LEVEL_REQUIREMENT = 47,
    SPELL_FAILED_LINE_OF_SIGHT = 48,
    SPELL_FAILED_LOWLEVEL = 49,
    SPELL_FAILED_LOW_CASTLEVEL = 50,
    SPELL_FAILED_MAINHAND_EMPTY = 51,
    SPELL_FAILED_MOVING = 52,
    SPELL_FAILED_NEED_AMMO = 53,
    SPELL_FAILED_NEED_AMMO_POUCH = 54,
    SPELL_FAILED_NEED_EXOTIC_AMMO = 55,
    SPELL_FAILED_NEED_MORE_ITEMS = 56,
    SPELL_FAILED_NOPATH = 57,
    SPELL_FAILED_NOT_BEHIND = 58,
    SPELL_FAILED_NOT_FISHABLE = 59,
    SPELL_FAILED_NOT_FLYING = 60,
    SPELL_FAILED_NOT_HERE = 61,
    SPELL_FAILED_NOT_INFRONT = 62,
    SPELL_FAILED_NOT_IN_CONTROL = 63,
    SPELL_FAILED_NOT_KNOWN = 64,
    SPELL_FAILED_NOT_MOUNTED = 65,
    SPELL_FAILED_NOT_ON_TAXI = 66,
    SPELL_FAILED_NOT_ON_TRANSPORT = 67,
    SPELL_FAILED_NOT_READY = 68,
    SPELL_FAILED_NOT_SHAPESHIFT = 69,
    SPELL_FAILED_NOT_STANDING = 70,
    SPELL_FAILED_NOT_TRADEABLE = 71,
    SPELL_FAILED_NOT_TRADING = 72,
    SPELL_FAILED_NOT_UNSHEATHED = 73,
    SPELL_FAILED_NOT_WHILE_GHOST = 74,
    SPELL_FAILED_NOT_WHILE_LOOTING = 75,
    SPELL_FAILED_NO_AMMO = 76,
    ...
    SPELL_FAILED_NO_ACTIONS = 186,
    SPELL_FAILED_CURRENCY_WEIGHT_MISMATCH = 187,
    SPELL_FAILED_CURRENCY_WEIGHT_NOT_ENOUGH = 188,
    SPELL_FAILED_CURRENCY_WEIGHT_TOO_MUCH = 189,
    SPELL_FAILED_NO_VACANT_SEAT = 190,
    SPELL_FAILED_UNKNOWN = 191,
