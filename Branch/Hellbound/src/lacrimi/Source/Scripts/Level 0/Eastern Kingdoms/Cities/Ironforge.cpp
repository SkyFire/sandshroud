...
//////////////////////////
// NPC: Royal Historian Archesonus(8879)
//////////////////////////
...
void Royal_Historian_Archesonus::GossipHello(Object * pObject, Player* Plr, bool AutoSend)
{
...
void Royal_Historian_Archesonus::GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * EnteredCode)
{
	GossipMenu* Menu;
	switch(IntId)
	{
...
{
	sMgr->register_gossip_script(8879, ((GossipScript*) new Royal_Historian_Archesonus()));
}
