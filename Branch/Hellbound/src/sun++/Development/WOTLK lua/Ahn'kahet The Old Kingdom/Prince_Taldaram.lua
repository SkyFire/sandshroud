...
function conjure(pUnit,Event)
	pUnit:FullCastSpellOnTarget(55931,pUnit:GetMainTank())
end

function vampyr(pUnit,Event)
	pUnit:FullCastSpellOnTarget(55959,pUnit:GetMainTank())
...
function Prince_Taldaram_OnDied(pUnit, event, player)
	--pUnit:PlaySoundToSet()
