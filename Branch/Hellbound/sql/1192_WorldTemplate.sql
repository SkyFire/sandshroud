...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='AI System';
...
CREATE TABLE `auctionhouse` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 COMMENT='Auction House';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Commands System';
...
CREATE TABLE `creature_spawns` (
  ...
  `ItemSlot1` int(10) unsigned NOT NULL DEFAULT '0',
  `ItemSlot2` int(10) unsigned NOT NULL DEFAULT '0',
  `ItemSlot3` int(10) unsigned NOT NULL DEFAULT '0',
...
-- ----------------------------
-- Table structure for db_version_check
-- ----------------------------
CREATE TABLE `db_version_check` (
  `revision` int(10) unsigned NOT NULL,
  `changeset_3` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`revision`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='this table is used for changesets import security';
...
CREATE TABLE `gameobject_spawns` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM AUTO_INCREMENT=2132189 DEFAULT CHARSET=cp1251 COLLATE=cp1251_general_cs PACK_KEYS=0 ROW_FORMAT=FIXED COMMENT='Spawn System';
...
CREATE TABLE `graveyards` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1721 DEFAULT CHARSET=utf8 COMMENT='Graveyard System';
...
CREATE TABLE `items` (
  ...
  `name2` varchar(1) NOT NULL DEFAULT '',
  `name3` varchar(1) NOT NULL DEFAULT '',
  `name4` varchar(1) NOT NULL DEFAULT '',
...
CREATE TABLE `map_checkpoint` (
  ...
  PRIMARY KEY (`entry`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Map System';
...
CREATE TABLE `quests` (
  ...
  `RequiredQuest_and_or` longtext NOT NULL,
  ...
  PRIMARY KEY (`entry`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Quests System';
...
CREATE TABLE `worldmap_info` (
  ...
  `viewingDistance` float unsigned NOT NULL DEFAULT '80',
