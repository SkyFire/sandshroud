...
public:
	...
	ONYX_INLINE size_t GetCount() { return AccountDatabase.size(); }
...
public:
	ONYX_INLINE Mutex & getServerSocketLock() { return serverSocketLock; }
	ONYX_INLINE Mutex & getRealmLock() { return realmLock; }
	...
	ONYX_INLINE void   AddServerSocket(LogonCommServerSocket * sock) { serverSocketLock.Acquire(); m_serverSockets.insert( sock ); serverSocketLock.Release(); }
	ONYX_INLINE void   RemoveServerSocket(LogonCommServerSocket * sock) { serverSocketLock.Acquire(); m_serverSockets.erase( sock ); serverSocketLock.Release(); }
