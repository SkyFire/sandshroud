...
public:
	...
	ONYX_INLINE uint32 GetID() { return id; }
	...
	ONYX_INLINE size_t GetNodeCount() { return m_pathNodes.size(); }
	TaxiPathNode* GetPathNode(uint32 i);
	ONYX_INLINE uint32 GetPrice() { return price; }
	ONYX_INLINE uint32 GetSource() { return from; }
