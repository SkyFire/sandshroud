...
#define BANNER "Onyx %s r%u/%s-%s-%s :: World Server"
...
bool Master::Run(int argc, char ** argv)
{
	...
	sLog.outColor( TBLUE, BANNER, BUILD_TAG, BUILD_REVISION, CONFIG, PLATFORM_TEXT, ARCH);
	sLog.outColor( TBLUE, "\nOnyx is the creation of Thetruecrow@Sandshroud, based off of Aspire's 2.4.3\n");
	sLog.outColor( TBLUE, "If you paid money for this code/program, sit in a corner and cry.\n");
	Log.Line();
