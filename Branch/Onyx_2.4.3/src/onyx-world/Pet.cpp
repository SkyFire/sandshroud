...
//	double pet_sta_bonus = 0.3 * (double)m_Owner->BaseStats[STAT_STAMINA];
	...
	static double R_pet_base_ap[70] = { 24, 26, 28, 30, 32, 34, 36, 38, 40, 42, 44, 46, 48, 50, 54, 56, 60, 64, 68, 70, 74, 78, 80, 84, 86, 90, 92, 96, 100, 102, 106, 108, 112, 114, 118, 120, 124, 128, 132, 136, 142, 152, 162, 174, 184, 188, 192, 196, 200, 206, 210, 214, 218, 224, 228, 234, 238, 242, 248, 252, 258, 262, 268, 272, 278, 282, 288, 292, 298, 304 };
