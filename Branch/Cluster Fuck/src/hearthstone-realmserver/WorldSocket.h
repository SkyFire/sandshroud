...
public:
	...
	HEARTHSTONE_INLINE void QueuePacket(uint16 opcode, size_t len, const void* data) { WorldPacket* pack = new WorldPacket(opcode, len); if(len) pack->append((uint8*)data, len); QueuePacket(pack); }
