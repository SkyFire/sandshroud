...
void HandleConsoleInput(BaseConsole * pConsole, const char * szInput)
{
	static ConsoleCommand Commands[] = {
		...
		{ &HandleQuitCommand, "exit", "none", "Shuts down server with optional delay in seconds." },
		{ &HandleQuitCommand, "quit", "none", "Shuts down server with optional delay in seconds." },
		{ &HandleQuitCommand, "shutdown", "none", "Shuts down server with optional delay in seconds." },
		{ &HandleQuitCommand, "restart", "none", "Restarts the server with optional delay in seconds." },
