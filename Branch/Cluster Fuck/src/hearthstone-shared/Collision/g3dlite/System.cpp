...
void System::memcpy(void* dst, const void* src, size_t numBytes) { ::memcpy(dst, src, numBytes); }
void System::memset(void* dst, uint8 value, size_t numBytes) { ::memset(dst, value, numBytes); }
...
#ifdef G3D_WIN32
	ASSERT( _CrtIsValidPointer(alignedPtr, uint(bytes), TRUE) );
#endif
