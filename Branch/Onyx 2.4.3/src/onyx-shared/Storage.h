...
public:
	 ...
	 */
	ONYX_INLINE T * Get() { return Pointer; }

	/** Sets the current object to P
	 */
	ONYX_INLINE void Set(T * P) { Pointer = P; }

	/** Are we at the end of the storage container?
	 */
	ONYX_INLINE bool AtEnd() { return (Pointer == 0); }
...
public:
	...
	ONYX_INLINE char * GetIndexName() { return _indexName; }
	ONYX_INLINE char * GetFormatString() { return _formatString; }
...
public:
	 ...
	 */
	ONYX_INLINE void LoadBlock(Field * fields, T * Allocated)
	{
