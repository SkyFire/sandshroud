...
public:
	...
	void Perform();
	ONYX_INLINE void SetDB(Database * dbb) { db = dbb; }
};
...
public:
	...
	ONYX_INLINE const string& GetHostName() { return mHostname; }
	ONYX_INLINE const string& GetDatabaseName() { return mDatabaseName; }
	ONYX_INLINE const uint32 GetQueueSize() { return queries_queue.get_size(); }
...
public:
	...
	ONYX_INLINE Field* Fetch() { return mCurrentRow; }
	ONYX_INLINE uint32 GetFieldCount() const { return mFieldCount; }
	ONYX_INLINE uint32 GetRowCount() const { return mRowCount; }
