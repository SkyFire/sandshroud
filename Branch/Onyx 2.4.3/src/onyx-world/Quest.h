...
public:
	...
	ONYX_INLINE Quest* GetQuest() { return m_quest; };
	...
	ONYX_INLINE bool IsCastQuest() { return iscastquest;}
	...
	ONYX_INLINE uint32 GetMobCount(uint32 i) { return m_mobcount[i]; }
	ONYX_INLINE uint32 GetExploredAreas(uint32 i) { return m_explored_areas[i]; }

	ONYX_INLINE uint32 GetBaseField(uint32 slot)
	{
