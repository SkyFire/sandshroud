...
public:
	...
	ONYX_INLINE bool IsArena() { return (m_type >= BATTLEGROUND_ARENA_2V2 && m_type <= BATTLEGROUND_ARENA_5V5); }
...
public:
	...
	ONYX_INLINE uint32 GetLevelGroup() { return m_levelGroup; }
	ONYX_INLINE MapMgr* GetMapMgr() { return m_mapMgr; }
	...
	/* Has it ended? */
	ONYX_INLINE bool HasEnded() { return m_ended; }
	ONYX_INLINE bool HasStarted() { return m_started; }
	...
	/* Full? */
	ONYX_INLINE bool IsFull() { return !(HasFreeSlots(0) || HasFreeSlots(1)); }
	...
	ONYX_INLINE uint32 GetStartTime() { return m_startTime; }
	ONYX_INLINE uint32 GetType() { return m_type; }
	...
	ONYX_INLINE uint32 GetLastResurrect() { return m_lastResurrect; }
