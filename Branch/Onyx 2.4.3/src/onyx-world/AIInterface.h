...
public:
	...
	ONYX_INLINE Unit* getUnitToFollow() { return UnitToFollow; }
	void setCreatureState(CreatureState state){ m_creatureState = state; }
	ONYX_INLINE uint8 getAIState() { return m_AIState; }
	ONYX_INLINE uint8 getAIType() { return m_AIType; }
	ONYX_INLINE uint8 getCurrentAgent() { return m_aiCurrentAgent; }
	...
	ONYX_INLINE AssistTargetSet GetAssistTargets() { return m_assistTargets; }
	ONYX_INLINE TargetMap *GetAITargets() { return &m_aiTargets; }
	...
	ONYX_INLINE size_t getAITargetsCount() { return m_aiTargets.size(); }
	ONYX_INLINE uint32 getOutOfCombatRange() { return m_outOfCombatRange; }
...
//	void CancelSpellCast();
	...
	ONYX_INLINE bool hasWaypoints() { return m_waypoints!=NULL; }
	ONYX_INLINE void setMoveType(uint32 movetype) { m_moveType = movetype; }
	ONYX_INLINE uint32 getMoveType() { return m_moveType; }
	ONYX_INLINE void setMoveRunFlag(bool f) { m_moveRun = f; }
	ONYX_INLINE bool getMoveRunFlag() { return m_moveRun; }
	...
	ONYX_INLINE bool GetAllowedToEnterCombat(void) { return m_AllowedToEnterCombat; }

	void CheckTarget(Unit* target);
	ONYX_INLINE void SetAIState(AI_State newstate) { m_AIState = newstate; }
	...
	ONYX_INLINE void AddStopTime(uint32 Time) { m_moveTimer += Time; }
	ONYX_INLINE void SetNextSpell(AI_Spell * sp) { m_nextSpell = sp; }
	ONYX_INLINE Unit* GetNextTarget() { return m_nextTarget; }
	ONYX_INLINE void SetNextTarget (Unit *nextTarget) 
	{ 
	...
	/*ONYX_INLINE void ResetProcCounts()
	{
		AI_Spell * sp;
	...
	ONYX_INLINE void SetPetOwner(Unit * owner) { m_PetOwner = owner; }
	...
	ONYX_INLINE void SetWaypointMap(WayPointMap * m) { m_waypoints = m; }
	bool m_isGuard;
//	bool m_fastMove;
