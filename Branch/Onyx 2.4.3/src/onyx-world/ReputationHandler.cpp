...
ONYX_INLINE void SetFlagAtWar(uint8 & flag)
{
...
ONYX_INLINE void UnsetFlagAtWar(uint8 & flag)
{
	if(!(flag & FACTION_FLAG_AT_WAR))
		return;
...
ONYX_INLINE void SetFlagVisible(uint8 & flag)
{
...
ONYX_INLINE void SetFlagPeaceForced(uint8 & flag)
{
...
ONYX_INLINE void SetForcedInvisible(uint8 & flag)
{
...
ONYX_INLINE void UnsetFlagVisible(uint8 & flag)
{
	if(!(flag & FACTION_FLAG_VISIBLE))
		return;
...
ONYX_INLINE bool AtWar(uint8 flag) { return (flag & FACTION_FLAG_AT_WAR) ? true : false; }
ONYX_INLINE bool Visible(uint8 flag) { return (flag & FACTION_FLAG_VISIBLE) ? true : false; }

ONYX_INLINE bool RankChanged(int32 Standing, int32 Change)
{
...
ONYX_INLINE bool RankChangedFlat(int32 Standing, int32 NewStanding)
{
