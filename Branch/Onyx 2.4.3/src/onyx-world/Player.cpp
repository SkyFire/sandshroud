...
ONYX_INLINE uint32 GetSpellForLanguage(uint32 SkillID)
{
	switch(SkillID)
	{
...
bool Player::HasNoFallDamageAura()
{
	uint32 invincibleauracount = 6;
	uint32 invincibleauras[6] = { 642, 1020, 1022, 5599, 10278, 45438 };
	// Hard coding power.
	for(uint32 i = 0; i < invincibleauracount; ++i)
		if(HasAura(invincibleauras[i]))
			return true;
