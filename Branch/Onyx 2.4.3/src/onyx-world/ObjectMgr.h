...
ONYX_INLINE bool FindXinYString(std::string& x, std::string& y)
{
...
public:
	...
	ONYX_INLINE void SetTextID(uint32 TID) { TextId = TID; }
...
public:
	...
	ONYX_INLINE uint32 GetLeader() { return LeaderGuid; }
	ONYX_INLINE uint32 GetID() { return CharterId; }
...
#ifdef onyx_USE_MAP_PLAYER_INDEX
...
public:
	...
	ONYX_INLINE bool IsSpellDisabled(uint32 spellid)
	{
	...
	ONYX_INLINE GuildMap::iterator GetGuildsBegin() { return mGuild.begin(); }
	ONYX_INLINE GuildMap::iterator GetGuildsEnd() { return mGuild.end(); }
