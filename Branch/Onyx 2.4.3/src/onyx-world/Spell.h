...
ONYX_INLINE bool IsFlyingSpell(SpellEntry *sp)
{
...
public:
	...
	ONYX_INLINE SpellEntry *GetSpellProto() { return m_spellInfo; }
...
/*        switch(m_spellInfo->NameHash)
	...
	ONYX_INLINE static bool HasMechanic(SpellEntry * sp, uint32 MechanicsType)
	{
	...
	ONYX_INLINE static uint32 GetMechanic(SpellEntry * sp)
	{
		if(sp->MechanicsType)
	...
	ONYX_INLINE static uint32 GetMechanicOfEffect(SpellEntry * sp, uint32 i)
	{
