...
public:
	...
	/** Gets MOTD
	 */
	ONYX_INLINE const char * GetMOTD() const { return m_motd; }
	 ...
	 */
	ONYX_INLINE const char * GetGuildInformation() const { return m_guildInfo; }
	...
	/** Getters :P
	 */
	ONYX_INLINE const char * GetGuildName() const { return m_guildName; }
	ONYX_INLINE const uint32 GetGuildLeader() const { return m_guildLeader; }
	ONYX_INLINE const uint32 GetGuildId() const { return m_guildId; }
	ONYX_INLINE const uint32 GetBankTabCount() const { return m_bankTabCount; }
	ONYX_INLINE const uint32 GetBankBalance() const { return m_bankBalance; }
	ONYX_INLINE const size_t GetNumMembers() const { return m_members.size(); }
	 ...
	 */
	ONYX_INLINE GuildRank * GetGuildRank(uint32 Id)
	{ 
	...
	ONYX_INLINE GuildBankTab * GetBankTab(uint32 Id)
	{
	 ...
	 */
	ONYX_INLINE GuildMember * GetGuildMember(PlayerInfo * pInfo)
	{
