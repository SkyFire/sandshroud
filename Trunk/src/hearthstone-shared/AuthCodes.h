...
enum LoginErrorCode
{
	...
	RESPONSE_VERSION_MISMATCH									= 0x05,

	CSTATUS_CONNECTING											= 0x06,
	CSTATUS_NEGOTIATING_SECURITY								= 0x07,
	CSTATUS_NEGOTIATION_COMPLETE								= 0x08,
	CSTATUS_NEGOTIATION_FAILED									= 0x09,
	CSTATUS_AUTHENTICATING										= 0x0A,

	AUTH_OK														= 0x0B,
	AUTH_FAILED													= 0x0C,
	AUTH_REJECT													= 0x0D,
	AUTH_BAD_SERVER_PROOF										= 0x0E,
	AUTH_UNAVAILABLE											= 0x0F,
	AUTH_SYSTEM_ERROR											= 0x10,
	AUTH_BILLING_ERROR											= 0x11,
	AUTH_BILLING_EXPIRED										= 0x12,
	AUTH_VERSION_MISMATCH										= 0x13,
	AUTH_UNKNOWN_ACCOUNT										= 0x14,
	AUTH_INCORRECT_PASSWORD										= 0x15,
	AUTH_SESSION_EXPIRED										= 0x16,
	AUTH_SERVER_SHUTTING_DOWN									= 0x17,
	AUTH_ALREADY_LOGGING_IN										= 0x18,
	AUTH_LOGIN_SERVER_NOT_FOUND									= 0x19,
	AUTH_WAIT_QUEUE												= 0x1A,
	AUTH_BANNED													= 0x1B,
	AUTH_ALREADY_ONLINE											= 0x1C,
	AUTH_NO_TIME												= 0x1D,
	AUTH_DB_BUSY												= 0x1E,
	AUTH_SUSPENDED												= 0x1F,
	AUTH_PARENTAL_CONTROL										= 0x20,
	AUTH_LOCKED_ENFORCED										= 0x21,
	...
	CHAR_CREATE_EXPANSION_CLASS									= 0x39,
	CHAR_CREATE_LEVEL_REQUIREMENT								= 0x3A,
	CHAR_CREATE_UNIQUE_CLASS_LIMIT								= 0x3B,
	CHAR_CREATE_CHARACTER_IN_GUILD								= 0x3C,
	CHAR_CREATE_RESTRICTED_RACECLASS							= 0x3D,
	CHAR_CREATE_CHARACTER_CHOOSE_RACE							= 0x3E,
	CHAR_CREATE_CHARACTER_ARENA_LEADER							= 0x3F,
	CHAR_CREATE_CHARACTER_DELETE_MAIL							= 0x40,
	CHAR_CREATE_CHARACTER_SWAP_FACTION							= 0x41,
	CHAR_CREATE_CHARACTER_RACE_ONLY								= 0x42,
	CHAR_CREATE_CHARACTER_GOLD_LIMIT							= 0x43,
	CHAR_CREATE_FORCE_LOGIN										= 0x44,
	...
	CHAR_LOGIN_LOCKED_BY_MOBILE_AH 								= 0x55,
