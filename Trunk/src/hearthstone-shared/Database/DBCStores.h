...
HEARTHSTONE_INLINE uint32 GetscalestatArmorMod(ScalingStatValuesEntry *ssvrow, uint32 flags)
{
	if(flags & 0x00F001E0)
	{
		if(flags & 0x00000020)
...
HEARTHSTONE_INLINE uint32 GetscalestatDPSMod(ScalingStatValuesEntry *ssvrow, uint32 flags)
{
	if(flags & 0x7E00)
	{
		if(flags & 0x00000200)
