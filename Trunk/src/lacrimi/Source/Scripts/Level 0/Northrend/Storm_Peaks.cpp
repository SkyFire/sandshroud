...
{
	// The Gifts of Loken
	sMgr->register_gameobject_script(192120, &LokensFury::Create);
	sMgr->register_gameobject_script(192121, &LokensPower::Create);
	sMgr->register_gameobject_script(192122, &LokensFavor::Create);
	sMgr->register_gossip_script(29811, ((GossipScript *)(new MissingScout_Gossip())));
}
