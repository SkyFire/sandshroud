...
void SetupMagistersTerraceTrash(ScriptMgr* pScriptMgr) 
{
	//Trash Mobs
...
{
	SetupSelinFireheart(pScriptMgr);
	SetupVexallus(pScriptMgr);
	SetupPriestessDelrissa(pScriptMgr);
	SetupFelbloodKaelthas(pScriptMgr);
	SetupMagistersTerraceTrash(pScriptMgr);
}
