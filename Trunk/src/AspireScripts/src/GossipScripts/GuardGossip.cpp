...
public:
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
        ...
        case 1:     // Auction House
            SendQuickMenu(3834);
            Plr->Gossip_SendPOI(-8811.47, 667.47, 6, 6, 0, "Stormwind Auction House");
            break;
        ...
        case 16: //Mage
            {
                Plr->Gossip_SendPOI(-9012.0, 867.7, 6, 6, 0, "Wizard`s Sanctum");
                SendQuickMenu(899);
            }break;
        ...
        case 22: //Warrior
            {
                Plr->Gossip_SendPOI(-8714.14, 334.97, 6, 6, 0, "Stormwind Barracks");
                SendQuickMenu(901);
            }break;
        ...
        case 25: //Cooking
            {
                Plr->Gossip_SendPOI(-8611.0, 364.7, 6, 6, 0, "Pig and Whistle Tavern");
                SendQuickMenu(921);
            }break;
...
public:
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
		...
		case 7:		// Stable Master
			SendQuickMenu(5980);
			Plr->Gossip_SendPOI(10167.20, 2522.67, 6, 6, 0, "Alassin");
			break;
		...
		case 12:	// Druid
            {
                Plr->Gossip_SendPOI(10186, 2570.47, 6, 6, 0, "Darnassus Druid Trainer");
                SendQuickMenu(3024);
            }break;
		...
		case 17: //Alchemy
            {
                Plr->Gossip_SendPOI(10075.90, 2356.77, 6, 6, 0, "Darnassus Alchemy Trainer");
                SendQuickMenu(3035);
            }break;
        ...
        case 22: //Herbalism
            {
                Plr->Gossip_SendPOI(9757.17, 2430.17, 6, 6, 0, "Darnassus Herbalism Trainer");
                SendQuickMenu(3039);
            }break;
...
public:
	...
	void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
	   ...
	   case 6:     //Class Trainer
		...
		case 12: //Priest
            {
                Plr->Gossip_SendPOI(-9461.07, 32.7, 6, 6, 0, "Priestess Josetta");
                SendQuickMenu(4267);
            }break;
		...
		case 19: //Cooking
            {
                Plr->Gossip_SendPOI(-9467.54, -3.17, 6, 6, 0, "Tomas");
                SendQuickMenu(4276);
            }break;
		...
		case 27: //Skinning
            {
                Plr->Gossip_SendPOI(-9536.91, -1212.77, 6, 6, 0, "Helene Peltskinner");
                SendQuickMenu(4284);
            }break;
...
public:
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
        ...
        case 7:     // The zeppelin master
            SendQuickMenu(3519);
            Plr->Gossip_SendPOI(2059, 274.87, 6, 6, 0, "Undercity Zeppelin");
            break;

        case 8:     // The weapon master
            SendQuickMenu(4521);
            Plr->Gossip_SendPOI(1670.31, 324.67, 6, 6, 0, "Archibald");
            break;

        case 9:     // The stable master
            SendQuickMenu(5979);
            Plr->Gossip_SendPOI(1634.18, 226.77, 6, 6, 0, "Anya Maulray");
            break;
        ...
        case 16: //Rogue
            {
                Plr->Gossip_SendPOI(1418.57, 65, 7, 6, 0, "Undercity Rogue Trainers");
                SendQuickMenu(3526);
            }break;

        case 17: //Warlock
            {
                Plr->Gossip_SendPOI(1780.92, 53.17, 6, 6, 0, "Undercity Warlock Trainers");
                SendQuickMenu(3526);
            }break;
        ...
        case 26: //Herbalism
            {
                Plr->Gossip_SendPOI(1558, 349.37, 6, 6, 0, "Undercity Herbalism Trainer");
                SendQuickMenu(3535);
            }break;
        ...
        case 29: //Skinning
            {
                Plr->Gossip_SendPOI(1498.6, 196.47, 6, 6, 0, "Undercity Skinning Trainer");
                SendQuickMenu(3538);
            }break;
...
public:
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
		...
		case 11: // Rogue
			{
				Plr->Gossip_SendPOI(9789, 942.87, 6, 6, 0, "Jannok Breezesong");
				SendQuickMenu(4327);
			}break;
		...
		case 15: // Enchanting
			{
				Plr->Gossip_SendPOI(10677.59, 1946.57, 6, 6, 0, "Alanna Raveneye");
				SendQuickMenu(4331);
			}break;
		...
		case 19: // Leatherworking
			{
				Plr->Gossip_SendPOI(10152.59, 1681.47, 6, 6, 0, "Nadyia Maneweaver");
				SendQuickMenu(4335);
			}break;
...
public:
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
        ...
        case 14: //To the east - Auction House no. 2
            {
                Plr->Gossip_SendPOI(9682.864, -7515.787, 6, 6, 0, "Silvermoon City, Auction House");
                SendQuickMenu(9316);
            }break;
        ...
        case 28: //Cooking
            {
                Plr->Gossip_SendPOI(9577.26, -7243.7, 6, 6, 0, "Silvermoon City, Cooking");
                SendQuickMenu(9316);
            }break;
        ...
        case 31: //First Aid
            {
                Plr->Gossip_SendPOI(9588.61, -7337.527, 6, 6, 0, "Silvermoon City, First Aid");
                SendQuickMenu(9316);
            }break;
...
public:
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
        ...
        case 14: //Hunter
            {
                Plr->Gossip_SendPOI(-4229.36, -11563.37, 6, 6, 0, "Exodar, Hunter Trainers");
                SendQuickMenu(9316);
            }break;
        ...
        case 16: //Paladin
            {
                Plr->Gossip_SendPOI(-4176.57, -11476.47, 6, 6, 0, "Exodar, Paladin Trainers");
                SendQuickMenu(9316);
            }break;
        ...
        case 26: //Herbalism
            {
                Plr->Gossip_SendPOI(-4052.5, -11356.7, 6, 6, 0, "Exodar, Herbalism Trainer");
                SendQuickMenu(9316);
            }break;
...
public:
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
		...
		case 33: //Tailoring
            {
                Plr->Gossip_SendPOI(1802.66, -4560.67, 6, 6, 0, "Magar's Cloth Goods");
                SendQuickMenu(2518);
            }break;
        }
    }
...
public:
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
        ...
        case 2:     // The wind rider master
            SendQuickMenu(1293);
            Plr->Gossip_SendPOI(-1196.43, 28.27, 6, 6, 0, "Wind Rider Roost");
            break;
        ...
        case 5:     // The mailbox
            SendQuickMenu(3154);
            Plr->Gossip_SendPOI(-1263.59, 44.37, 6, 6, 0, "Thunder Bluff Mailbox");
            break;
        ...
        case 7:     // The weapon master
            SendQuickMenu(4520);
            Plr->Gossip_SendPOI(-1282.31, 89.57, 6, 6, 0, "Ansekhwa");
            break;
        ...
        case 21: //Enchanting
            {
                Plr->Gossip_SendPOI(-1112.65, 48.27, 6, 6, 0, "Dawnstrider Enchanters");
                SendQuickMenu(1335);
            }break;
        ...
        case 25: //Leatherworking
            {
                Plr->Gossip_SendPOI(-1156.22, 66.87, 6, 6, 0, "Thunder Bluff Armorers");
                SendQuickMenu(1339);
            }break;
...
public:
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
        ...
        case 4:     // The stable master
            SendQuickMenu(5976);
            Plr->Gossip_SendPOI(-2338.86, -357.57, 6, 6, 0, "Seikwa");
            break;
...
public:
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
        ...
        case 4:     // The stable master
            SendQuickMenu(5973);
            Plr->Gossip_SendPOI(330.31, -4710.67, 6, 6, 0, "Shoja'my");
            break;
        ...
        case 8: //Mage
            {
                Plr->Gossip_SendPOI(-839.33, -4935.7, 6, 6, 0, "Un'Thuwa");
                SendQuickMenu(4014);
            }break;
        ...
        case 13: //Warrior
            {
                Plr->Gossip_SendPOI(312.3, -4824.67, 6, 6, 0, "Tarshaw Jaggedscar");
                SendQuickMenu(4019);
            }break;
...
public:
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
        ...
        case 1:     // Auction House
            SendQuickMenu(3014);
            Plr->Gossip_SendPOI(-4957.39, -911.7, 6, 6, 0, "Ironforge Auction House");
            break;
        ...
        case 20: //Shaman
			{
                Plr->Gossip_SendPOI(-4722.02, -1150.67, 6, 6, 0, "Ironforge Shaman Trainer");
                SendQuickMenu(1299);
            }break;
		...
		case 32: //Tailoring
            {
                Plr->Gossip_SendPOI(-4719.60, -1056.97, 6, 6, 0, "Stonebrow's Clothier");
                SendQuickMenu(2807);
            }break;
        }
    }
...
public:
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
        ...
        case 13: //Warlock
            {
                Plr->Gossip_SendPOI(-5641.97, -523.77, 6, 6, 0, "Gimrizz Shadowcog");
                SendQuickMenu(4298);
            }break;
        ...
        case 21: //Fishing
            {
                Plr->Gossip_SendPOI(-5202.39, -51.37, 6, 6, 0, "Paxton Ganter");
                SendQuickMenu(4307);
            }break;
...
public:
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
        ...
        case 10: //Paladin <-- Needs to change flag to other sign (don't know how to describe it)
			{
                Plr->Gossip_SendPOI(9516.05, -6870.97, 6, 6, 0, "Falconwing Square, Paladin Trainer");
                SendQuickMenu(2593);
            }break;
...
public:
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
        ...
        case 12: //Priest
            {
                Plr->Gossip_SendPOI(-4131.66, -12478.7, 6, 6, 0, "Azure Watch, Priest Trainer");
                SendQuickMenu(2593);
            }break;
