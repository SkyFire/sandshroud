...
public:
	...
	void OnActivate(Player * pPlayer)
	{
		...
		// We save player data in  *as well as his position for further use
	...
	void AIUpdate()
	{
		...
		// We check if  *has Channeler data and if so we check if that channeler is alive, in world and if channels Cube
		if (Channeler && (!Channeler->isAlive() || !Channeler->IsInWorld()))
		{
