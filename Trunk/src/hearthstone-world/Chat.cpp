...
void CommandTableStorage::Init()
{
	...
	static ChatCommand debugCommandTable[] =
	{
		...
		{ "aimove",						COMMAND_LEVEL_D, &ChatHandler::HandleAIMoveCommand,							"",																														NULL, 0, 0, 0 },
		...
		{ "itempushresult",				COMMAND_LEVEL_D, &ChatHandler::HandleSendItemPushResult,					"sends item push result",																								NULL, 0, 0, 0 },
		...
		{ "aispelltestbegin",			COMMAND_LEVEL_D, &ChatHandler::HandleAIAgentDebugBegin,						"",																														NULL, 0, 0, 0 },
		{ "aispelltestcontinue",		COMMAND_LEVEL_D, &ChatHandler::HandleAIAgentDebugContinue,					"",																														NULL, 0, 0, 0 },
		{ "aispelltestskip",			COMMAND_LEVEL_D, &ChatHandler::HandleAIAgentDebugSkip,						"",																														NULL, 0, 0, 0 },
		{ "dumpcoords",					COMMAND_LEVEL_D, &ChatHandler::HandleDebugDumpCoordsCommmand,				"",																														NULL, 0, 0, 0 },
		{ "sendpacket",					COMMAND_LEVEL_D, &ChatHandler::HandleSendpacket,							"<opcode ID>, <data>",																									NULL, 0, 0, 0 },
		{ "sqlquery",					COMMAND_LEVEL_D, &ChatHandler::HandleSQLQueryCommand,						"<sql query>",																											NULL, 0, 0, 0 },
	...
	static ChatCommand waypointCommandTable[] =
	{
		...
		{ "save",					COMMAND_LEVEL_W, &ChatHandler::HandleSaveWaypoints,					"Save all waypoints",									NULL, 0, 0, 0 },
	...
	static ChatCommand GuildCommandTable[] =
	{
		...
		{ "rename",					COMMAND_LEVEL_M, &ChatHandler::HandleRenameGuildCommand,		"Renames a guild Syntax:<new name>.",						NULL, 0, 0, 0 },
		{ "members",				COMMAND_LEVEL_M, &ChatHandler::HandleGuildMembersCommand,		"Lists guildmembers and their ranks.",						NULL, 0, 0, 0 },
		...
		{ "setleader",				COMMAND_LEVEL_M, &ChatHandler::HandleGuildSetLeaderCommand,		"Sets the guild leader of the target's guild to <player>",	NULL, 0, 0, 0 },
		{ NULL,						COMMAND_LEVEL_0, NULL,											"",															NULL, 0, 0, 0 }
	};
	...
	static ChatCommand NPCCommandTable[] =
	{
		...
		{ "addAgent",				COMMAND_LEVEL_N, &ChatHandler::HandleAddAIAgentCommand,			".npc addAgent <agent> <procEvent> <procChance> <procCount> <spellId> <spellType> <spelltargetType> <spellCooldown> <floatMisc1> <Misc2>",		NULL, 0, 0, 0 },
		{ "listAgent",				COMMAND_LEVEL_N, &ChatHandler::HandleListAIAgentCommand,		".npc listAgent",																																NULL, 0, 0, 0 },
		...
		{ "return",					COMMAND_LEVEL_N, &ChatHandler::HandleNpcReturnCommand,			".npc return - Returns ncp to spawnpoint.",																										NULL, 0, 0, 0 },
		...
		{ "save",					COMMAND_LEVEL_Z, NULL,											"",																																				NULL, 0, 0, 0 },
		{ NULL,						COMMAND_LEVEL_0, NULL,											"",																																				NULL, 0, 0, 0 }
	};
	...
	static ChatCommand CheatCommandTable[] =
	{
		...
		{ "god",					COMMAND_LEVEL_M, &ChatHandler::HandleGodModeCommand,				"Sets god mode, prevents you from taking damage.",	NULL, 0, 0, 0 },
	...
	static ChatCommand questCommandTable[] =
	{
		...
		{ "list",					COMMAND_LEVEL_2, &ChatHandler::HandleQuestListCommand,			"Lists the quests for the npc <id>",							NULL, 0, 0, 0 },
	...
	static ChatCommand commandTable[] = {
		...
		{ "exitinstance",			COMMAND_LEVEL_M, &ChatHandler::HandleExitInstanceCommand,						"Exits current instance, return to entry point.", NULL, 0, 0, 0 },
		...
		{ "formationlink1",			COMMAND_LEVEL_M, &ChatHandler::HandleFormationLink1Command,						"Sets formation master.", NULL, 0, 0, 0 },
		{ "formationlink2",			COMMAND_LEVEL_M, &ChatHandler::HandleFormationLink2Command,						"Sets formation slave with distance and angle", NULL, 0, 0, 0 },
		{ "formationclear",			COMMAND_LEVEL_M, &ChatHandler::HandleFormationClearCommand,						"Removes formation from creature", NULL, 0, 0, 0 },
