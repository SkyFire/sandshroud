...
public:
	...
	/** Gets MOTD
	 */
	HEARTHSTONE_INLINE const char * GetMOTD() const { return m_motd; }
	 ...
	 */
	HEARTHSTONE_INLINE const char * GetGuildInformation() const { return m_guildInfo; }
	 ...
	 */
	HEARTHSTONE_INLINE GuildMember * GetGuildMember(PlayerInfo * pInfo)
	{
