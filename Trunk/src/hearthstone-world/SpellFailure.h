...
enum SpellCastError
{
	...
	SPELL_FAILED_TARGET_NO_RANGED_WEAPONS                        = 123,
	SPELL_FAILED_TARGET_UNSKINNABLE                              = 124,
	SPELL_FAILED_THIRST_SATIATED                                 = 125,
	SPELL_FAILED_TOO_CLOSE                                       = 126,
	SPELL_FAILED_TOO_MANY_OF_ITEM                                = 127,
	SPELL_FAILED_TOTEM_CATEGORY                                  = 128,
	SPELL_FAILED_TOTEMS                                          = 129,
	...
	SPELL_FAILED_PARTIAL_PLAYTIME                                = 162,
	SPELL_FAILED_NO_PLAYTIME                                     = 163,
	SPELL_FAILED_NOT_IN_BATTLEGROUND                             = 164,
	SPELL_FAILED_NOT_IN_RAID_INSTANCE                            = 165,
	SPELL_FAILED_ONLY_IN_ARENA                                   = 166,
	SPELL_FAILED_TARGET_LOCKED_TO_RAID_INSTANCE                  = 167,
	SPELL_FAILED_ON_USE_ENCHANT                                  = 168,
	SPELL_FAILED_NOT_ON_GROUND                                   = 169,
	SPELL_FAILED_CUSTOM_ERROR                                    = 170,
	SPELL_FAILED_TOO_MANY_SOCKETS                                = 171,
	SPELL_FAILED_INVALID_GLYPH                                   = 172,
	SPELL_FAILED_UNIQUE_GLYPH                                    = 173,
	SPELL_FAILED_GLYPH_SOCKET_LOCKED                             = 174,
	SPELL_FAILED_NO_VALID_TARGETS                                = 175,
	SPELL_FAILED_ITEM_AT_MAX_CHARGES                             = 176,
	SPELL_FAILED_NOT_IN_BARBERSHOP                               = 177,
	SPELL_FAILED_FISHING_TOO_LOW                                 = 178,
	SPELL_FAILED_ITEM_ENCHANT_TRADE_WINDOW                       = 179,
	SPELL_FAILED_SUMMON_PENDING                                  = 180,
	SPELL_FAILED_MAX_SOCKETS                                     = 181,
