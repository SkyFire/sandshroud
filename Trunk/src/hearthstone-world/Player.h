...
enum ClassMasks
{
	CLASSMASK_WARRIOR		= 0x0001,
	CLASSMASK_PALADIN		= 0x0002,
	CLASSMASK_HUNTER		= 0x0004,
	CLASSMASK_ROGUE			= 0x0008,
	CLASSMASK_PRIEST		= 0x0010,
	CLASSMASK_DEATHKNIGHT	= 0x0020,
	CLASSMASK_SHAMAN		= 0x0040,
	CLASSMASK_MAGE			= 0x0080,
	CLASSMASK_WARLOCK		= 0x0100,
	CLASSMASK_DRUID			= 0x0400
};
