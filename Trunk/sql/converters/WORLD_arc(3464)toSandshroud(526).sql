...
CHANGE COLUMN `normal10percentchance` `percentchance` FLOAT NOT NULL DEFAULT '0' AFTER `itemid`,
  DROP COLUMN `index`,  DROP COLUMN `normal25percentchance`,  DROP COLUMN `heroic10percentchance`,
  DROP COLUMN `heroic25percentchance`,  DROP INDEX `index`;
...
ALTER TABLE `loot_pickpocketing`  CHANGE COLUMN `normal10percentchance` `percentchance` FLOAT NOT NULL DEFAULT '0' AFTER `itemid`,  DROP COLUMN `index`,  DROP COLUMN `normal25percentchance`,  DROP COLUMN `heroic10percentchance`,  DROP COLUMN `heroic25percentchance`,  DROP INDEX `index`;
